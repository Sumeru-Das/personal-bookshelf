...
const SearchInput = ({ query, setQuery }) => {
  return (
    <div className="relative">
      ...
      />
      <div className="absolute top-5 right-20 transform -translate-y-1/2 hidden lg:block">
        <img src={search} alt="" />
      </div>
      <div className="absolute top-5 right-9 transform -translate-y-1/2 hidden lg:block">
        <img src={tally} alt="" />
      </div>
      <div className="absolute top-5 right-3 transform -translate-y-1/2">
